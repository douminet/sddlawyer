...
function ResizeTextarea(a,row){
  ...
  <body>
  	<form action="wenzhang_updWenZhang.action?tablename=${tablename}&currentPage=1" method="post">
  			...
  			<div id="addPartMain" class="addPartMain">
  				...
  				<div id="addTitle" class="addText">
  					...
  					<div id="ttinput" class="input">
  						<input name="wenZhang.title" type="text" value="${wenZhang.title}">
  					</div>
  				...
  				<div id="addAuthor" class="addText">
	  				<div id="at" class="text">
	  					...
	  					<div id="atinput" class="input">
	  						<input name="wenZhang.author" type="text" value="${wenZhang.author}">
	  					</div>
	  				...
	  				<div id="at" class="text">
	  					...
	  					<div id="atinput" class="input">
	  						<input name="wenZhang.date" type="text" value="${wenZhang.date}">
	  					</div>
  				...
  				<div id="addMain" class="addMain">
	  				...
	  				<div id="textar" class="textar">
	  					<textarea name="wenZhang.main">${wenZhang.main}</textarea>
	  				</div>
